<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $query="INSERT INTO `desserts`(dish,cost,duration) 
...
<body>
    ...
    <div class="container col-lg-6 bg-light shadow-lg" id="padding">
        <h3 class="text-center">New Dessert</h3>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary text-center">Add Dessert</button>
