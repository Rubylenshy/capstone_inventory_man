<?php
    include('../includes/connection.php');
        $id= $_GET['up_appetizers_id'];

        $sql="SELECT * FROM `appetizers_bev` where `id`='$id'";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $query="UPDATE `appetizers_bev` set dish='$dish', cost='$cost', duration='$duration' where id='$id'";
...
<head>
    ...
    <title>Appetizer/Beverage</title>
    <style>
        /* html, body{
...
<body>
    ...
    <div class="container col-lg-6 bg-light shadow-lg" id="padding">
        <h3 class="text-center">Edit Appetizer/Beverage</h3>
