<?php
    include('../includes/connection.php');
        ...
        $sql="SELECT * FROM `main_dish` where `id`='$id'";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $query="UPDATE `main_dish` set dish='$dish', cost='$cost', duration='$duration' where id='$id'";
...
<body>
    ...
    <div class="container col-lg-6 bg-light shadow-lg" id="padding">
        <h3 class="text-center">Edit Main Dish</h3>
